function read_Intan_RHD2000_file_nonotch_automatic(file, path)
...
% OVERRIDE NOTCH_FILTER_MODE -- REVERT IF NEEEDED
...
if (data_present)
    ...
    %%% UNCOMMENT HERE to use the NOTCH_FILTER FUNCTION
