...
%         [feature_matrix_one_file, class_one_file]=Func_DISC_RV_v2(NeuralData, channels_interest,LFPbandflag, featureflag);
        ...
        if isempty(temp2)==0     
            ...
            DC_offset=[];
            [~, temp2]=find(All_Channels==NeuralData(temp2).Channel_Number); % column were max amplitude value is
            temp2=All_Channels(:,temp2); % Extract the column channel values
...
%             data_summary(row_num).DC_offset=DC_offset';
            ...
            data_summary(row_num).Amplitude_LFP_ChNum=NaN;
            data_summary(row_num).Amplitude_LFP_Ch_Impedance=NaN;
